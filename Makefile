...
srcroot := 
objroot := 
abs_srcroot := /home/libaolb/Project/jemalloc-readcode/
abs_objroot := /home/libaolb/Project/jemalloc-readcode/

# Build parameters.
CPPFLAGS :=  -D_GNU_SOURCE -D_REENTRANT -I$(srcroot)include -I$(objroot)include
CFLAGS := -std=gnu99 -Wall -Werror=declaration-after-statement -Wsign-compare -pipe -g3 -fvisibility=hidden -O0
LDFLAGS := 
EXTRA_LDFLAGS := 
LIBS :=  -lpthread
RPATH_EXTRA := 
